...
About Us      </h2>
    ...
    <div className="md:max-w-3xl mx-auto">
      ...
      <p className="mb-8 text-base md:text-lg text-coolGray-400 font-medium">
        <span data-config-id="auto-txt-13-1">
          Non massa enim vitae duis mattis. Vel in
        </span>
        <a
          className="hover:text-coolGray-600 underline"
          href="#"
          data-config-id="auto-txt-14-1"
        >
          ultricies
        </a>
        <span data-config-id="auto-txt-15-1">vel fringilla.</span>
      </p>
      <h3
        className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800"
...
Greathill: Leading the Way in Technology Advancements from Montenegro      </h3>
      ...
      <div className="flex items-center justify-center">
        ...
        >
          ...
          <span
            className="ml-2 text-sm text-coolGray-500 hover:text-coolGray-600 font-medium"
...
<div class="py-6 sm:py-8 lg:py-12">
  <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
    <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        <div class="h-64 md:h-auto  overflow-hidden rounded-lg shadow-lg">
