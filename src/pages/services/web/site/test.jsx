...
<>
  <div className="" id="content">
    <section
      ...
      data-component-id="4659488c_06_awz"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4 flex items-center justify-center">
              <img
                src="https://cdn.pixabay.com/photo/2023/01/31/09/52/insect-7757601_960_720.jpg"
                alt=""
        ...
        <nav className="relative flex flex-col py-6 px-6 h-full w-full bg-white border-r overflow-y-auto">
          ...
          <div className="mt-auto">
            ...
            <p className="my-4 text-xs text-center text-gray-400">
              <span data-config-id="copy">© 2020 All rights reserved.</span>
            </p>
    ...
    <section
      data-section-id={2}
      data-share=""
      data-category="features-dark-color"
      data-component-id="d5624b32_02_awz"
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
              <div className="max-w-md lg:mx-auto">
                ...
                <h2
                  className="my-2 text-4xl lg:text-5xl font-bold font-heading text-white"
            ...
            <div className="w-full lg:w-1/2 flex flex-wrap -mx-4">
              <div className="mb-8 lg:mb-0 w-full md:w-1/2 px-4">
                <div className="mb-8 py-6 pl-6 pr-4 shadow-md rounded bg-gray-800">
                  ...
                  <h4
                    className="mb-2 text-2xl font-bold font-heading text-white"
    ...
    <section
      ...
      data-component-id="e848cd6e_02_awz"
      data-config-id="background"
    >
      <div className="skew skew-top mr-for-radius">
        <svg
      ...
      <div className="py-20 bg-green-600 radius-for-skewed">
        <div className="container mx-auto px-4">
          <div className="mb-16 mx-auto max-w-md text-center">
            <span className="text-green-400 font-bold" data-config-id="caption">
              Dolor sit amet consectutar
            </span>
            <h2
    ...
    <section
      ...
      data-component-id="61098559_02_awz"
      className="py-20"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap text-center -mx-4">
          <div className="mb-8 w-full lg:w-1/2 px-3">
            <div className="relative py-10 bg-white shadow rounded">
              <img
                className="absolute inset-0 mt-2 mx-auto"
                src="atis-assets/elements/puzzle.svg"
                alt=""
                data-config-id="auto-img-1"
              />
              <h4 className="mb-1 text-green-600" data-config-id="desc1">
                Total Revenue
              </h4>
              <span
          ...
          <div className="mb-8 w-full lg:w-1/2 px-3">
            <div className="relative py-10 bg-white shadow rounded">
              <img
                ...
                data-config-id="auto-img-2"
              />
              <h4 className="mb-2 text-green-600" data-config-id="desc2">
                Subscribers
              </h4>
              <span
                className="text-3xl lg:text-4xl font-bold"
          ...
          <div className="mb-8 w-full lg:w-1/2 px-3">
            <div className="relative py-10 bg-white shadow rounded">
              <img
                ...
                data-config-id="auto-img-3"
              />
              <h4 className="mb-2 text-green-600" data-config-id="desc3">
                Conversations
              </h4>
              <span
                className="text-3xl lg:text-4xl font-bold"
          ...
          <div className="mb-8 w-full lg:w-1/2 px-3">
            <div className="relative py-10 bg-white shadow rounded">
              ...
              />
              <h4 className="mb-2 text-green-600" data-config-id="desc4">
                Modal Sale Rate
              </h4>
              <span
                className="text-3xl lg:text-4xl font-bold"
