      ...
      <div className="relative">
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            <h2 className="mb-6 font-sans text-3xl font-bold font-medium text-7xl md:text-10xl xl:text-11xl leading-tight  text-white sm:text-4xl sm:leading-none">
            ...
            Driving Growth and Success through Customized Software Development and Tech Consultancy.
            </p>
