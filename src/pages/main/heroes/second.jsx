      ...
      <div className="flex flex-wrap -m-8">
        <div className="w-full md:w-1/2 p-8">
          <div className="md:max-w-sm">
            ...
            <h2
              className="font-heading mb-8 text-4xl text-gray-900 font-black tracking-tight"
        ...
        <div className="w-full md:w-1/2 p-8">
          <div className="flex flex-wrap -m-4">
            <div className="w-full lg:w-1/2 p-4">
              <div className="flex flex-col justify-between p-8 h-full bg-gray-100 border border-gray-100 rounded-3xl" style={{
              backgroundImage:
              ...
              backgroundRepeat: 'no-repeat',
                ...
                <h3
                  className="font-heading text-xl text-gray-900 font-black xl:w-40"
