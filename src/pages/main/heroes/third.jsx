  ...
  return (
    <>
      <section
        ...
        data-component-id="9c5afa1c_03_awz"
      ...
      >
        <div className="relative bg-black overflow-hidden">
          ...
          />
          <img
            className="relative z-10 mx-auto transform hover:scale-105 transition ease-in-out duration-1000"
            src="https://shuffle.dev/flaro-assets/images/applications/iphones.png"
            alt=""
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p data-aos="zoom-in" data-aos-offset="200" className="mt-2  ">
                Code quality is the cornerstone of every successful software
                project.Our team of experts follows industry-leading best
                practices and takes a rigorous approach to quality assurance,
                ensuring that our code meets the highest standards of
